...
const CompanyLogoFinder = () => {
  ...
  const handleBulkInput = () => {
    const urlsInputElement = document.getElementById(
      "urls",
    ) as HTMLInputElement;
    if (urlsInputElement) {
      ...
      <div className="w-full">
        <div className="flex flex-col items-center justify-center w-full">
          ...
          <div className="flex flex-row gap-1.5 mb-2">
            <Button className="gap-1" size="sm" onClick={addRow}>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                ...
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction onClick={handleBulkInput}>
                    Submit
                  </AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
          ...
          <p className="text-xs mt-1">
            ...
            . Logos provided by{" "}
            <a href="https://clearbit.com" className="font-medium underline">
              Clearbit
            </a>
            .
          </p>
